...
function BuildingPlan() {
  return (
   ...
   At Bhavani Engineers, we provide innovative and professional solutions for residential, commercial, industrial, 
  and institutional projects clients clearly understand the final appearance of their projects before construction begins.
        </p>
...
✅ Building Supervision <br />
        ...
        <p className="designation">
          ✓ Better visualization of the project <br />
✓ Accurate space planning <br />
✓ Reduced construction errors <br />
✓ Improved project presentation <br />
✓ Cost-effective planning and execution <br />
